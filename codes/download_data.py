...
# -*- coding: utf-8 -*-
"""
Created on Mon Apr  4 14:35:56 2022
...
#    }
    file_manifest = {
            'full': ['gefe-quadtree-main.zip',
                     'Rules - Global Earthquake Forecast Testing Experiment on Multi-Resolution Quadtree Grids.pdf'
                    ],
            'light': ['Rules - Global Earthquake Forecast Testing Experiment on Multi-Resolution Quadtree Grids.pdf']
                     }
...
#    }
    dir_map = {
            'gefe-quadtree-main.zip' : './data',
            'Rules - Global Earthquake Forecast Testing Experiment on Multi-Resolution Quadtree Grids.pdf': './read'
            }
