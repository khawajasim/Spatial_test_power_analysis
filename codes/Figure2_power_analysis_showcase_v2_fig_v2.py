...
#    Nsim = int(Nsim)
    ...
    if run_sim == 'Y' or run_sim == 'y':   
        ...
        for Nc2 in Nc2_all:
            ...
            outname = '../Data/power_analysis_showcase/powertest-Z%.0f-Ncell%.0f-Nsim%d-sigma%.1f.out' % (Z, 2*Nc2, Nsim_1,sigma_1)
            f = open(outname, 'w')
    ...
    #    print('---Number of Cells :', Ncell)
        outname = '../Data/power_analysis_showcase/powertest-Z%.0f-Ncell%.0f-Nsim%d-sigma%.1f.out' % (Z, Ncell, Nsim_1,sigma_1) #Z=3
        ...
        #Data 2---
        outname_2 = '../Data/power_analysis_showcase/powertest-Z%.0f-Ncell%.0f-Nsim%d-sigma%.1f.out' % (Z, Ncell, Nsim_2,sigma_2) #Z=3
