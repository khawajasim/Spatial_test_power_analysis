    ...
    if run_evaluations_again =='Y' or run_evaluations_again =='y': 
        ...
        #-----------Wheel Zoom = 11
            ...
            if plot_normalize == True:
                ...
                ax.figure.savefig('../Data/Figures/poisson_stest_'+name+'_normalize.png', dpi = 250)
                ax.figure.savefig('../Data/Figures/poisson_stest_'+name+'_normalize.svg')
            else:
                ax.set_xlabel('Log-likelihood')
                ax.figure.tight_layout()
                ax.figure.savefig('../Data/Figures/poisson_stest_'+name+'.png', dpi = 250)
                ax.figure.savefig('../Data/Figures/poisson_stest_'+name+'.svg')
        ...
        #    plt.savefig(folder+name+'/stest_'+name+'.png', dpi = 250)
            with open(results_folder+'poisson_stest_'+name+'.dat', 'wb') as f:
                pickle.dump(stest_all, f)
    
    else:
        for name in names:
            with open(results_folder+'poisson_stest_'+name+'.dat', 'rb') as f:
